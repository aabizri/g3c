<main>
    ...
    <form method="post" action="TODO: Use JS for correct navigation" id="choixsalle">
    ...
    <div id="action">
        ...
        <form action="">
            <div id="actionspieces">
                <p>Température voulue(°C)<br><br><input type="number" class="action"
                                                        name="temperaturevoulue"/><br><br><input type="submit"
                                                                                                 value="Valider"
                                                                                                 id="valider"/></p>
                <p>Luminosité voulue(%)<br><br><input type="number" class="action"
                                                      name="luminositevoulue"/><br><br><input type="submit"
                                                                                              value="Valider"
                                                                                              id="valider"/></p>
