<main>
    ...
    <div id="modules">
        ...
        <div class="module" id="peripherals" onclick="window.location.href = 'index.php?c=Admin&a=Peripherals'"
        ...
        <div class="module" id="products" onclick="window.location.href = 'index.php?c=Admin&a=Products'"
