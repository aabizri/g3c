    <footer>
        <p id="SAV">Contacter le service client <a href="SAV">ici</a><br/><a href="http://localhost/website/index.php?c=FAQ&a=FAQ&debug=true">FAQ</a><br><a href="Mentions légales">Mentions légales</a></p>
